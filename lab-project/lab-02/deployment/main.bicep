...
@description('The fully qualified frontend container image name (e.g. myregistry.azurecr.io/ultimate-snake-lab02-frontend:latest).')
param frontendContainerImage string

@description('The fully qualified API container image name (e.g. myregistry.azurecr.io/ultimate-snake-lab02-api:latest).')
